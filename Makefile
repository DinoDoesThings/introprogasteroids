...
Prototype_1: raylib
ifneq (,$(Prototype_1_config))
	@echo "==== Building Prototype_1 ($(Prototype_1_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Prototype_1.make config=$(Prototype_1_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Prototype_1.make clean
